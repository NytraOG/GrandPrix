        ...
        public void RegisterDriver(List<string> commandArgs)
        {
            ...
            switch (driverType)
            {
                case Konstanten.DriverTypeAggressive when tireType == Konstanten.TireTypeHard:
                    listofDrivers.Add(new AggressiveDriver(driverName,
                                                           new CarModel(new HardTire(tireHardness), horsePower,
                                                                        fuelAmount)));
                    break;
                case Konstanten.DriverTypeAggressive when tireType == Konstanten.TireTypeUltrasoft:
                    listofDrivers.Add(new AggressiveDriver(driverName,
                                                           new CarModel(new UltrasoftTire(tireHardness, tireGrip),
                                                                        horsePower, fuelAmount)));
                    break;
                case Konstanten.DriverTypeEndurance when tireType == Konstanten.TireTypeHard:
                    listofDrivers.Add(new EnduranceDriver(driverName,
                                                          new CarModel(new HardTire(tireHardness), horsePower,
                                                                       fuelAmount)));
                    break;
